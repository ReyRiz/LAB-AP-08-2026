...
## JIKA ADA HAL YANG ERROR TOLONG HUBUNGI ASISTEN MASING MASING, NANTI AKAN DIBANTU SELESAIKAN
...
2. **Clone** repositori hasil **fork** anda
   ...
   git clone https://github.com/YOUR_USERNAME/LAB-AP-08-2026.git
...
8. Setelah asistensi dan tugas anda disetujui, **push** seluruh _file_ jawaban yang telah anda buat
   ...
   #6. Tuliskan note untuk token anda (ex: Token for LAB-AP-08-2026)
